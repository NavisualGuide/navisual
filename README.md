...
- **Cursor position in supported apps** — in Word, the page/section/line your cursor is on, the paragraph style, and the text of the paragraph you are in (long ones truncated). The screenshot already carries those words; a screenshot cannot show a text cursor.
...
- Screenshots are held in memory — nothing is written to disk unless you choose to save it (e.g. debug captures in Developer settings), and anything saved stays on your machine
